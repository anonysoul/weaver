...
## Milestone 7：镜像交付与版本规范

### 目标
- 项目以 Docker 镜像形式交付，并具备标准化版本标记
- Weaver 项目镜像与 Codex 镜像交付版本统一为 `latest`

### 验收标准
- Weaver 项目可完成 `docker build` 并交付镜像
- Codex 镜像可完成构建并被项目引用交付
- 两类交付镜像的 tag 均为 `latest`
